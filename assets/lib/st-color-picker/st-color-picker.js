...
$(document).ready(function () {
	...
	function colorParser(colorValues) {
		...
		var colorMinVal = Math.min.apply(null, colorValues),
			colorMaxVal = Math.max.apply(null, colorValues);
		...
		colorMinVal = Math.min.apply(null, colorValues);
		colorMaxVal = Math.max.apply(null, colorValues);
